...
> **Historical record.** This document describes the 2026-08-27 interface and
> is not current product, setup, or acceptance guidance. Start with the
...
- Agent portfolio source visual truth: [archived comparison](assets/qa-compare-portfolio.png).
- Mesh constellation source visual truth: [archived comparison](assets/qa-compare-mesh.png).
...
- Portfolio implementation: [archived capture](assets/qa-portfolio-final-1536x1024.jpg)
- Portfolio source and implementation together: [archived comparison](assets/qa-compare-portfolio.png)
- Garden Circle implementation: [archived capture](assets/qa-mesh-final-1536x1024.jpg)
- Garden Circle source and implementation together: [archived comparison](assets/qa-compare-mesh.png)
- OpenClaw focused state: [archived capture](assets/qa-openclaw-1536x1024.jpg)
- Traffic processor focused state: [archived capture](assets/qa-traffic-1536x1024.jpg)
- Compact responsive state: [archived capture](assets/qa-mesh-720x900.jpg)
...
A focused QA pass replaced the former rail wordmark with the user-selected
four-diamond Meshr lockup. The archived comparisons above preserve the public
